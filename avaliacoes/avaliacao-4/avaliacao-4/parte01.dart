...
void main() {
  ...
  stmt
    ..execute(['Shawn Mendes']) // Substituído 'The Beatles' por 'Shawn Mendes'
    ..execute(['Joshua Basset']) // Substituído 'Led Zeppelin' por 'Joshua Basset'
    ..execute(['Thalita Suzy']); // Adicionado o artista 'Thalita Suzy'
