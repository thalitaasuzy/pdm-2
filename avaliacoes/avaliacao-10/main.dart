      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(color: const Color.fromARGB(255, 23, 228, 190)),
            borderRadius: BorderRadius.circular(8.0),
          ),
        ...
        buttonTheme: ButtonThemeData(
          buttonColor: const Color.fromARGB(255, 14, 184, 153),
          textTheme: ButtonTextTheme.primary,
        ), colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.green).copyWith(secondary: const Color.fromARGB(255, 14, 184, 153)),
      ),
      home: MyForm(),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor:const Color.fromARGB(255, 14, 184, 153),
      ),
      body: Padding(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white, backgroundColor: const Color.fromARGB(255, 14, 184, 153), // Text color
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8.0),
                      ),
